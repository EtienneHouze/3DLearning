...
//
// $URL$
// $Id: pnm_impl.h,v 1.2 2017/02/06 12:37:06 Emmanuel.Pot Exp $
//
//
...
int writePpmImage( char *name,_image *im )
{
  ...
  string << PPM_MAGIC << "\n";
  string << "# CREATOR: pnm.c $Revision: 1.2 $ $Date: 2017/02/06 12:37:06 $\n";
...
int writePgmImage(char *name,_image *im  )
{
  ...
  sprintf( string, "# CREATOR: pnm.c $Revision: 1.2 $ $Date: 2017/02/06 12:37:06 $\n" );
  ImageIO_write( im, string, strlen( string ) );
